...
namespace VaccineApp.Migrations
{
    ...
    [Migration("20210521075017_status")]
            ...
            modelBuilder.Entity("VaccineApp.Entities.Login", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Email = "test1",
                            PasswordHash = new byte[] { 84, 133, 118, 97, 126, 88, 27, 159, 216, 209, 45, 17, 43, 116, 126, 31, 241, 137, 2, 223, 230, 52, 188, 220, 89, 220, 200, 237, 205, 18, 208, 109, 173, 207, 229, 222, 196, 83, 247, 6, 90, 2, 145, 71, 10, 46, 198, 50, 159, 200, 68, 138, 186, 27, 13, 255, 41, 163, 197, 171, 178, 244, 90, 178 },
                            PasswordSalt = new byte[] { 99, 19, 229, 231, 53, 175, 171, 143, 35, 55, 120, 177, 158, 194, 250, 48, 110, 41, 12, 91, 229, 139, 75, 91, 243, 155, 59, 171, 80, 234, 207, 171, 8, 189, 6, 214, 114, 186, 161, 89, 42, 227, 230, 19, 45, 211, 12, 137, 233, 55, 92, 197, 131, 53, 127, 182, 38, 80, 183, 12, 19, 69, 94, 81, 199, 225, 254, 29, 167, 225, 254, 42, 190, 201, 32, 226, 228, 240, 3, 107, 136, 32, 123, 146, 63, 207, 41, 8, 18, 13, 72, 103, 173, 169, 30, 243, 92, 186, 85, 84, 235, 194, 223, 37, 216, 140, 71, 131, 183, 254, 206, 191, 83, 90, 88, 10, 198, 12, 61, 183, 235, 172, 130, 73, 51, 107, 47, 105 }
                        },
                        new
                        {
                            Id = 2,
